...
- Name: quiz.spec.ts >> Marriage Quiz App >> should show results with score breakdown
- Location: e2e\quiz.spec.ts:72:3
...
Locator: getByText('Answer Breakdown')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Answer Breakdown')
